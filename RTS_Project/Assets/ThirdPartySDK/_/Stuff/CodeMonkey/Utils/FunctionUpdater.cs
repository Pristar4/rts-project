...
namespace CodeMonkey.Utils
{
	...
	public class FunctionUpdater
	{
		...
		private static List<FunctionUpdater>
				updaterList; // Holds a reference to all active updaters
		...
		private readonly Func<bool>
				updateFunc; // Destroy Updater if return true;
		private bool active;

		public FunctionUpdater(GameObject gameObject, Func<bool> updateFunc,
		                       string functionName, bool active)
		{
		                                     ...
		                                     bool stopAllWithSameName)
		{
			...
			var functionUpdater
					= new FunctionUpdater(gameObject, updateFunc, functionName,
							active);
			gameObject.GetComponent<MonoBehaviourHook>().OnUpdate
					= functionUpdater.Update;
