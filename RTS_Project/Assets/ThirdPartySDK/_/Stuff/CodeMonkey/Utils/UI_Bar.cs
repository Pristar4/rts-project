...
namespace CodeMonkey.Utils
{
	...
	public class UI_Bar
	{
		...
		public UI_Bar(Transform parent, Vector2 anchoredPosition, Vector2 size,
		              Color barColor, float sizeRatio)
		{
		...
		public UI_Bar(Transform parent, Vector2 anchoredPosition, Vector2 size,
		              Color barColor, float sizeRatio, Outline outline)
		{
			SetupParent(parent, anchoredPosition, size);
		...
		public UI_Bar(Transform parent, Vector2 anchoredPosition, Vector2 size,
		              Color backgroundColor, Color barColor, float sizeRatio)
		{
			SetupParent(parent, anchoredPosition, size);
		...
		{
			return UtilsClass.DrawSprite(outline.color, gameObject.transform,
					Vector2.zero,
		...
		{
			background = UtilsClass.DrawSprite(backgroundColor,
		...
		{
			bar = UtilsClass.DrawSprite(barColor, gameObject.transform,
					Vector2.zero,
					Vector2.zero, "Bar");
		...
		{
			var outlineRectTransform = SetupOutline(outline, size);
